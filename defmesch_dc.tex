...
It is mainly developed for vectorial machines and allows to vectorize easily all elements of a same color.
...
As illustrated in figure~\ref{fig:DCexe}, this results in a partitioning tree where each leaf is associated to an independent Cilk task and executes the assembly on its sub-domain.
...
In order to have finer permutations without multiply Cilk tasks, it is possible to stop the recursion earlier.
