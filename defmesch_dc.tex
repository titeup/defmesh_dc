...
The “Elasticity operator” option permits mesh deformations of greater magnitude and smoother deformed meshes than the “Laplacian operator”.
...
We performed our experiments on an unstructured meshes from Dassault Aviation, called EIB and illustrated in the figure~\ref{fig:reservoir}.
It is composed of 6 346 108 elements and 1 079 758 nodes and it represents the displacement of fuel tank along an airplane fuselage.
\begin{figure}[htp]
 \centering
 \subfigure[]{\label{fig:EIB3D}\includegraphics[width=0.49\textwidth]{reservoir_3D.png}}
 \subfigure[]{\label{fig:EIB_proj}\includegraphics[width=0.49\textwidth]{reservoir_projection.png}}
 ...
 \subfigure[]{\label{fig:EIB_middle}\includegraphics[width=0.32\textwidth]{reservoir_bas.png}}
