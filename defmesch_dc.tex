...
\subsection{To do}
 Atomics\\
 Unstructured Mesh Code Parallel Implementation\\
...
The sub-domains created by recursive bisections are not sharing any element ans thus, can be executed in parallel.
...
\subsubsection{Recursive Task Tree}
Starting from the recursion tree shown in \ref{RecTree}, the Cilk implementation is then straightforward.
